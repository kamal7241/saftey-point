...
export const SomethingWentWrong: React.FC<SomethingWentWrongProps> = ({
    ...
    const defaultMessage = message || t("something_went_wrong");
    return (
        <div className="flex flex-col items-center justify-center min-h-[200px] p-4">
            <h2 className="text-xl font-semibold text-gray-800 mb-2">{t("oops")}</h2>
            <p className="text-gray-600 text-center">{defaultMessage}</p>
            <button
                type="button"
                onClick={() => router.back()}
