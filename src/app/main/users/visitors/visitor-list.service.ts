...
@Injectable()
export class VisitorListService extends ApiService {
  public routeEndPoint: string = "visitor-list";
  ...
  uploadImage(file: File): Promise<ApiResult<any>> {
    ...
    return this.postMultiDataResponse(`user/upload-media`, formData);
  }
}
